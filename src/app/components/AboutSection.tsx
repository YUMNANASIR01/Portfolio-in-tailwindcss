...
function AboutSection() {
  return (
    <>
      <section id='about' className='w-full py-[160px] px-10 bg-[#5d76ae] flex flex-col md:flex-row justify-center'>
        
        <div className='mx-auto w-[50%] px-[16px] flex flex-col items-start text-left'>
          <p className={`${caveat.className} text-[48px]`}>YUMNA NASIR</p>
          
          <p className={`${caveat.className} text-[30px] mt-2 mb-6 text-light-beige text-center lg:text-start text-3xl text-[#131b54]`}>Freelance Web Developer</p>
        ...
        <div className='w-[50%] sm:w-[55%] lg:w-[60%] mx-auto md:-mt-[100px] md:-mr-[40px] rounded-full flex justify-center items-center'>
          <Image src={"/myImage/pro-pic.png"} alt='picture' width={600} height={450} className='rounded-full'></Image>
        </div>
      </section>
      
      <section className="w-full py-5 px-5 mx-auto flex justify-center items-center gap-16 bg-[#4b0f4b] overflow-hidden">
